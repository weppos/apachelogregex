...
This library has not been released yet. This program seems stable, but should be considered a development release.

Changes to specifications may occur at any time and without notice. For full list of changes look at the CHANGELOG file. 
